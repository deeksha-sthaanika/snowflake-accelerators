...
# SP_JOB_SCRIPT('"""+DB_NAME+"."+SCHEMA_NAME+""".JOB_SCRIPTS','{arg4}',{arg5},'"""+DB_NAME+"."+SCHEMA_NAME+""".JOB_SCRIPTS_AUDIT_TABLE')"""
...
SCRIPT_NAME = "SELECT *  FROM "+DB_NAME+"."+SCHEMA_NAME+".JOB_SCRIPTS ORDER BY SCRIPT_NAME,SEQ_ID"

SEQ_ID = "SELECT  JOB_ID,SEQ_ID AS SEQ_ID FROM "+DB_NAME+"."+SCHEMA_NAME+".JOB_SCRIPTS WHERE SCRIPT_NAME='{arg2}' ORDER BY SEQ_ID"

STORED_PROC="""CALL  SP_JOB_SCRIPT('"""+DB_NAME+"."+SCHEMA_NAME+""".JOB_SCRIPTS', 
'{arg2}', '"""+DB_NAME+"."+SCHEMA_NAME+""".JOB_SCRIPTS_AUDIT_TABLE','{arg3}') 
"""

STORED_PROC_RUN_ID="""CALL  SP_JOB_SCRIPT('"""+DB_NAME+"."+SCHEMA_NAME+""".JOB_SCRIPTS', 
'{arg2}',{arg3}, '"""+DB_NAME+"."+SCHEMA_NAME+""".JOB_SCRIPTS_AUDIT_TABLE','{arg4}')
"""

STORED_PROC_RUN_ID_ARR="""CALL  SP_JOB_SCRIPT('"""+DB_NAME+"."+SCHEMA_NAME+""".JOB_SCRIPTS', 
'{arg2}',{arg3}, '"""+DB_NAME+"."+SCHEMA_NAME+""".JOB_SCRIPTS_AUDIT_TABLE','{arg4}')"""

STORED_PROC_RUN_ID_TASK="""CALL  SP_JOB_SCRIPT_TASK('"""+DB_NAME+"."+SCHEMA_NAME+""".JOB_SCRIPTS', 
...
INSERT_JOB_SCRIPT="INSERT INTO "+DB_NAME+"."+SCHEMA_NAME+".JOB_SCRIPTS({arg2}) VALUES({arg3})"

UPDATE_JOB_SCRIPT="UPDATE "+DB_NAME+"."+SCHEMA_NAME+".JOB_SCRIPTS SET {arg2} WHERE {arg3}"

DELETE_JOB_SCRIPT="DELETE FROM "+DB_NAME+"."+SCHEMA_NAME+".JOB_SCRIPTS WHERE {arg2}"
