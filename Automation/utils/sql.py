...
PROMO_INSERT="INSERT INTO "+DB_NAME+"."+SCHEMA_NAME+".JOB_SCRIPTS{arg2}(SCRIPT_NAME,JOB_ID,SEQ_ID,SQL_COMMAND,CONTINUE_ON_ERROR,IGNORE_SCRIPT) SELECT SCRIPT_NAME,JOB_ID,SEQ_ID,SQL_COMMAND,CONTINUE_ON_ERROR,IGNORE_SCRIPT FROM JOB_SCRIPTS{arg1} where script_name='{arg3}'"

INSERT_JOB_SCRIPT_TEST="""MERGE INTO """+DB_NAME+"""."""+SCHEMA_NAME+""".JOB_SCRIPTS{arg2} AS TGT
USING 
(SELECT * FROM JOB_SCRIPTS{arg1} where script_name='{arg3}') AS SRC 
ON SRC.SCRIPT_NAME=TGT.SCRIPT_NAME AND SR.SEQ_ID=TGT.SEQ_ID
...
WHEN MATCHED THEN
UPDATE SET (TGT.JOB_ID,TGT.SCRIPT_NAME,TGT.SEQ_ID,TGT.SQL_COMMAND,TGT.CONTINUE_ON_ERROR,TGT.IGNORE_SCRIPT)
VALUES(SRC.JOB_ID,SRC.SCRIPT_NAME,SRC.SEQ_ID,SRC.SQL_COMMAND,SRC.CONTINUE_ON_ERROR,SRC.IGNORE_SCRIPT)"""
